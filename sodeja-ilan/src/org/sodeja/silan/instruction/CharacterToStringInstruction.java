...
public class CharacterToStringInstruction extends PrimitiveInstruction {
	public CharacterToStringInstruction(ImageObjectManager manager) {
		super(manager);
	}
	...
	public void execute(Process process) {
		...
		SILObject result = manager.newString(String.valueOf(i1.value));
		mc.push(result);
	}
}
