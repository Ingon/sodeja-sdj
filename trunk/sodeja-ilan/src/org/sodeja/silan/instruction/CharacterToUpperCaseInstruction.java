...
public class CharacterToUpperCaseInstruction extends PrimitiveInstruction {
	public CharacterToUpperCaseInstruction(ImageObjectManager manager) {
		super(manager);
	}
	...
	public void execute(Process process) {
		...
		SILObject result = manager.newCharacter(Character.toUpperCase(i1.value));
		mc.push(result);
	}
}
